...
exports["default"] = exports.MapFishPrintV2VectorSerializer = void 0;
...
/**
 * The MapFishPrintV2VectorSerializer.
 *
 * @class
 */
var MapFishPrintV2VectorSerializer =
/*#__PURE__*/
function (_BaseSerializer) {
  _inherits(MapFishPrintV2VectorSerializer, _BaseSerializer);
   ...
   * The constructor
   */
  function MapFishPrintV2VectorSerializer() {
    var _this;

    _classCallCheck(this, MapFishPrintV2VectorSerializer);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(MapFishPrintV2VectorSerializer).call(this, arguments));
  ...
  _createClass(MapFishPrintV2VectorSerializer, [{
    key: "serialize",
    value: function serialize(layer, viewResolution) {
      ...
      var serialized = _objectSpread({}, _get(_getPrototypeOf(MapFishPrintV2VectorSerializer.prototype), "serialize", this).call(this, layer, source), {}, {
  ...
  return MapFishPrintV2VectorSerializer;
}(_BaseSerializer2["default"]);

exports.MapFishPrintV2VectorSerializer = MapFishPrintV2VectorSerializer;

_defineProperty(MapFishPrintV2VectorSerializer, "TYPE_VECTOR", 'Vector');

_defineProperty(MapFishPrintV2VectorSerializer, "CIRCLE_GEOMETRY_TYPE", 'Circle');

_defineProperty(MapFishPrintV2VectorSerializer, "FEAT_STYLE_PROPERTY", '_style');

_defineProperty(MapFishPrintV2VectorSerializer, "sourceCls", [_Vector["default"]]);

var _default = MapFishPrintV2VectorSerializer;
