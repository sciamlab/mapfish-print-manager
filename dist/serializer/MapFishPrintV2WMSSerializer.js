...
exports["default"] = exports.MapFishPrintV2WMSSerializer = void 0;
 ...
 * @class
 */
var MapFishPrintV2WMSSerializer =
/*#__PURE__*/
function (_BaseSerializer) {
  _inherits(MapFishPrintV2WMSSerializer, _BaseSerializer);
   ...
   * The constructor
   */
  function MapFishPrintV2WMSSerializer() {
    _classCallCheck(this, MapFishPrintV2WMSSerializer);

    return _possibleConstructorReturn(this, _getPrototypeOf(MapFishPrintV2WMSSerializer).call(this, arguments));
  }
  /**
  ...
  _createClass(MapFishPrintV2WMSSerializer, [{
    key: "serialize",
    value: function serialize(layer) {
      ...
      var serialized = _objectSpread({}, _get(_getPrototypeOf(MapFishPrintV2WMSSerializer.prototype), "serialize", this).call(this, layer, source), {}, {
        ...
        singleTile: source instanceof _ImageWMS["default"],
        styles: stylesArray,
  ...
  return MapFishPrintV2WMSSerializer;
}(_BaseSerializer2["default"]);

exports.MapFishPrintV2WMSSerializer = MapFishPrintV2WMSSerializer;

_defineProperty(MapFishPrintV2WMSSerializer, "TYPE_WMS", 'WMS');

_defineProperty(MapFishPrintV2WMSSerializer, "sourceCls", [_ImageWMS["default"], _TileWMS["default"]]);

var _default = MapFishPrintV2WMSSerializer;
